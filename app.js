...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html('<p>' + itemData.info.plate + ': اللوحة</p>');
			
		//} else if (itemData.name == "vehiclekey") {
        //    $(".item-info-title").html('<p>' + itemData.info.vehname + '</p>');
		//	 $(".item-info-description").html(
		...
		//	);
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Document Type: </strong><span>" +
                itemData.info.headerTitle +
                "</span></p><p><strong>Last Name: </strong><span>" +
                itemData.info.headerLastName +
                "</span></p><p><strong> Date Created: </strong><span>" +
                itemData.info.headerDateCreated + 
                "</span></p><p><strong>From Job: </strong><span>" +
                itemData.info.headerJobLabel +
                "</span></p>"
            );
        ...
        if (
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $(".combine-option-container").fadeIn(500);
                    combineslotData = [];
